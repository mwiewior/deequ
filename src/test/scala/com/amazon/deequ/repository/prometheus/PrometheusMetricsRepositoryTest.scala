...
package com.amazon.deequ.repository.prometheus
...
import main.scala.com.amazon.deequ.repository.prometheus.PrometheusMetricsRepository
import org.apache.spark.sql.{DataFrame, SparkSession}
import org.scalatest.WordSpec

import scala.util.{Failure, Success}

class PrometheusMetricsRepositoryTest extends WordSpec with SparkContextSpec with FixtureSupport {
  ...
  private[this] def createRepository(): MetricsRepository = {
    new PrometheusMetricsRepository("http://localhost:9091")
  }
